...
namespace StringCompare.Models
{
    public class DictionaryComparer
    {
        ...
        private Dictionary<int, TestModel> _testModels;
        ...
        public DictionaryComparer(Dictionary<int, TestModel> testModels)
        {
            _testModels = testModels;
            _testResult = new TestResult(TypeOfTest.Dictionary);
            ...
            stopwatch.Stop();
            _testResult.Results.Add("AllTimeElapsed_Dictionary", stopwatch.ElapsedMilliseconds);
        }
